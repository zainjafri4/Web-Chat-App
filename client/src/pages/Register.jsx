...
const Register = () => {
    const { registerInfo, updateRegisterInfo, registerUser, registerError, IsRegistorLoading } = useContext(AuthContext)
    return (
        <>
                    ...
                    <Col xs={6}>
                        <Stack gap={3}>
                            ...
                            <Button variant="primary" type="submit">
                                {IsRegistorLoading ? "Creating Your Account" : "Register"}
                            </Button>
                            {registerError?.error && 
